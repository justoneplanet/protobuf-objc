...
typedef NS_ENUM(int32_t, PBFieldDescriptorProto_Type) {
...
typedef NS_ENUM(int32_t, PBFieldDescriptorProto_Label) {
...
typedef NS_ENUM(int32_t, PBFileOptions_OptimizeMode) {
...
typedef NS_ENUM(int32_t, PBFieldOptions_CType) {
